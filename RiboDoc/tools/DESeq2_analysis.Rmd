...
```{r data , echo=FALSE}
pathway_matrix = paste0("../RESULTS/",DESeq2_folder,"/count_matrix.txt")
expData = read.table(pathway_matrix, header = T, row.names = 1, check.names = FALSE)

pathway_names = paste0("../RESULTS/",DESeq2_folder,"/transcript_list.txt")
...
write.table(allGenes,
            file = paste0("../RESULTS/",DESeq2_folder,"/complete.txt"),
            quote = F, sep = "\t", row.names = F)


write.table(inducedGenes,
            file = paste0("../RESULTS/",DESeq2_folder,"/up.txt"),
            quote = F, sep = "\t", row.names = F)

write.table(repressedGenes,
            file = paste0("../RESULTS/",DESeq2_folder,"/down.txt"),
            quote = F, sep = "\t", row.names = F)
```
\
**OUTPUT FILES** :  
