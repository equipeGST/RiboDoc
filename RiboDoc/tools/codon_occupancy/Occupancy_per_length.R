...
for (kmer in kmers){
  ...
  tiff(file = paste0(pathway_file_graphs,"graphs_by_length/",name_ref,"_vs_",name_test,"_",kmer,"_by_sample.tiff"),
      width = 1000,
      height = 500
  )
    suppressWarnings(print(histo + annotations + customPlot))
  ...
  tiff(file = paste0(pathway_file_graphs,"graphs_by_length/",name_ref,"_vs_",name_test,"_",kmer,"_mean_by_codon.tiff"),
      width = 1000,
      height = 500
  )
    suppressWarnings(print(
      plot_mean_signif + 
      customPlot + annotations))
  ...
  tiff(file = paste0(pathway_file_graphs,"graphs_by_length/",name_ref,"_vs_",name_test,"_",kmer,"_mean_with_error.tiff"),
    width = 1000,
    height = 500
  )
      
    suppressWarnings(print(plot_errors + customPlot + annotations))
  ...
  tiff(file = paste0(pathway_file_graphs,"graphs_by_length/",name_ref,"_vs_",name_test,"_",kmer,"_log-ratio.tiff"),
      width = 1000,
      height = 500
  )
    suppressWarnings(print(
