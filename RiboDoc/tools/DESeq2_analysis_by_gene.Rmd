...
expData_gene <- transcript_or_gene(expData, names_list, "gene")
```
...
ma_plot(resDESeq_gene, padj_threshold=Var_padj, logFC_threshold=Var_log2FC)
```
...
`r paste0("RESULTS/DESeq2/DESeq2_by_gene/gene_complete.txt")`  
`r paste0("RESULTS/DESeq2/DESeq2_by_gene/gene_up.txt")  `  
`r paste0("RESULTS/DESeq2/DESeq2_by_gene/gene_down.txt")  `   
\
