...
knitr::opts_chunk$set(fig.path = paste0(paths_list$DESeq2_gene,"Images/"), dev=c('tiff'))
```
...
```{r Library sizes by gene, fig.height = 3, fig.width = 4, echo=FALSE, dev=c('tiff')}
...
```{r Pairwise Scatter plot by gene, echo = FALSE, dev=c('tiff')}
