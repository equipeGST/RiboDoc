...
expData_transcript <- transcript_or_gene(data=expData, list_of_names=names_list, gene_transcript="transcript")
```
...
`r paste0("RESULTS/DESeq2/DESeq2_by_transcript/transcript_complete.txt")`  
`r paste0("RESULTS/DESeq2/DESeq2_by_transcript/transcript_up.txt")  `  
`r paste0("RESULTS/DESeq2/DESeq2_by_transcript/transcript_down.txt")  `   
\
